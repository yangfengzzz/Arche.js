...
export class SpringBase {
  // Oscillation per Second : How many Cycles (Pi*2) per second.
  oscPerSec = Math.PI * 2;
  // How much to slow down : Value between 0 and 1. 1 creates critical damping.
  damping = 1;
  epsilon = 0.01;

  setTarget(v: any): this {
